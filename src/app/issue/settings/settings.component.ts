...
export class SettingsComponent implements OnInit {
  ...
  constructor(private router: Router, private issueService: IssueService, private issueDetailsService: IssueDetailsService, private issueAssignedUsersService: IssueAssignedUsersService, private issuePredecessorService: IssuePredecessorService, private route: ActivatedRoute, private projectService: ProjectService, private modal: NzModalService) { }
  ...
  //Save issue
  submitForm() {
    if (this.issue.issueDetail.name.length > 0 && this.issue.state.name.length > 0 && this.issue.issueDetail.type.length > 0 && this.visibleInput.length > 0) {
      ...
      if (this.issueId != null) {
        ...
        this.projectService.getProject(this.companyId, this.projectId).subscribe(
          (dataProject) => {
            //Set Client
            this.issue.client = {
