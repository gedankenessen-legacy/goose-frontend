...
export class EmployeeDashboardComponent extends SubscriptionWrapper implements OnInit {
  ...
  constructor(private router: Router, private route: ActivatedRoute, private companyUserService: CompanyUserService) {
    super();
  }
